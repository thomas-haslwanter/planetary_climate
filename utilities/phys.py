...
- Physical constants
- Properties of gases
- Functions to calculate saturation pressure
...
* Database of interesting constants (e.g energy and C content of coal)
...
class gas:
    ...
    The properties do not need to be specified in the __init__
    ...
    creating their own gas objects.
    
    ToDo:
        - Add more documentation and help features
    ...
    def __repr__(self):
        ''' The __repr__ method allows us to print out a help string when
        the user types the name of a gas object
        '''
...
def satvpi(T):
    ...
    Returns
    -------
        pressure : saturation vapor pressure over ice [Pascal]
...
def satvpw(T):
    ...
    Returns
    -------
        pressure : saturation vapor pressure over liquid water [Pascal]
...
def satvpg(T):
    '''
    Saturation vapor pressure computation used in the GFDL climate model. 
    It blends over from water saturation ("satvpw") to
    ice saturation ("satvpi") as the temperature falls below 0C.
